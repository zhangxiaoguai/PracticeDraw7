    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // 1.通过ObjectAnimator.ofInt配合ArgbEvaluator实现颜色渐变
                ...
                // 2.通过ObjectAnimator.ofArgb直接实现
//                ObjectAnimator objectAnimator = ObjectAnimator.ofArgb(view, "color", 0xffff0000, 0xff00ff00);
